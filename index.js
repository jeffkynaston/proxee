...
const corsOptions = {
  origin: ['http://localhost:5173', 'http://localhost:5174', 'http://localhost:5175', 'http://localhost:5176', 'http://localhost:5177', 'http://localhost:5178', 'https://cdn.stage.goboomtown.com', 'https://zp1v56uxy8rdx5ypatb0ockcb9tr6a-oci3--5173--5a421e5b.local-credentialless.webcontainer-api.io/', 'https://*.local-credentialless.webcontainer-api.io/', 'https://*.netlify.app', 'https://*.webcontainer-api.io', 'https://credentialless.webcontainer-api.io', 'https://67dc7dba6172ba1110409551--cxme-ui.netlify.app', 'https://*.netlify.app', 'https://cxme-ui.netlify.app', 'https://cxme-ui.netlify.app/', 'https://appv5.stage-ovationcxm.app', 'https://app.ovationcxm.com' ],
  credentials: true,
